...
{
    public class LogOutXML:ITemplate<RLogOutRequest>
    {
        ...
        public XElement Run(RLogOutRequest model)
        {
            XElement xElement = new XElement(xmlns + "Envelope");
            var body = new XElement(xmlns + "Body");

            XElement LogoutRequest = new XElement(xmlnsLoginReq + "LogoutRequest");
            ...
            LogoutRequest.Add(REQUEST_HEADER);


            body.Add(LogoutRequest);
